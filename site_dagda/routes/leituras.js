...
router.get('/ultimas', function(req, res, next) {
	...
	const instrucaoSql = `select top ${limite_linhas} 
						...
						umidade, 
						tempoDataLeitura,
						FORMAT(tempoDataLeitura,'HH:mm:ss') as momento_grafico 
...
router.get('/tempo-real', function (req, res, next) {
	...
	const instrucaoSql = `select top 1 temperatura, umidade, FORMAT(tempoDataLeitura,'HH:mm:ss') as momento_grafico  
						from leitura order by idLeitura desc`;
